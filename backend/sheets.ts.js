...
var TEMPUS_SHEET_SCHEMAS = {
  timesheet_entries: {
    headers: ['id', 'date', 'duration_minutes', 'contract_id', 'created_at', 'punches_json', 'entry_type', 'hour_type_id', 'recurrence_id', 'note', 'assessment_id', 'source_type', 'source_id', 'source_occurrence_key', 'client_request_id', 'income_amount'],
  ...
  contracts: {
    ...
    headers: ['id', 'name', 'start_date', 'end_date', 'hourly_rate', 'total_hours', 'include_weekends', 'standard_hours_per_day', 'line_item_templates_json', 'color', 'archived', 'entry_mode', 'standard_day_json', 'created_at', 'specified_personnel', 'work_order_number', 'contract_reference', 'timesheet_statement', 'assessment_organisations'],
    ...
    text: ['id', 'name', 'start_date', 'end_date', 'include_weekends', 'line_item_templates_json', 'color', 'archived', 'entry_mode', 'standard_day_json', 'created_at', 'specified_personnel', 'work_order_number', 'contract_reference', 'timesheet_statement', 'assessment_organisations']
  },
  ...
  invoices: {
    headers: ['id', 'kind', 'year', 'month', 'sequence', 'invoice_number', 'invoice_date', 'status', 'revision_of_invoice_id', 'generated_doc_id', 'generated_doc_url', 'generated_at', 'template_doc_id', 'template_doc_path', 'output_folder_id', 'output_folder_path', 'notes', 'issued_at', 'sent_at', 'voided_at', 'void_reason', 'created_at', 'updated_at', 'source_month', 'content_hash', 'generation_request_id', 'pending_request_id', 'pending_started_at', 'pending_doc_id', 'retired_doc_ids_json', 'migration_warning', 'financial_snapshot_json'],
    defaults: { kind: 'standard', status: 'draft' },
    text: ['id', 'kind', 'invoice_number', 'invoice_date', 'status', 'revision_of_invoice_id', 'generated_doc_id', 'generated_doc_url', 'generated_at', 'template_doc_id', 'template_doc_path', 'output_folder_id', 'output_folder_path', 'notes', 'issued_at', 'sent_at', 'voided_at', 'void_reason', 'created_at', 'updated_at', 'source_month', 'content_hash', 'generation_request_id', 'pending_request_id', 'pending_started_at', 'pending_doc_id', 'retired_doc_ids_json', 'migration_warning', 'financial_snapshot_json']
  },
  invoice_line_items: {
    headers: ['id', 'invoice_id', 'is_default', 'default_label', 'position', 'line_date', 'description', 'hours', 'hour_type_id', 'hour_type_name_snapshot', 'amount', 'amount_mode', 'contract_id', 'contract_name_snapshot', 'timesheet_entry_id', 'entry_snapshot_json', 'last_synced_at', 'source_default_id', 'gst_code', 'gst_rate', 'gst_amount', 'source_type', 'source_id', 'source_line_id', 'created_at', 'updated_at', 'generation_id'],
    defaults: { gst_code: 'taxable', gst_rate: 0.1, source_type: 'manual' },
    text: ['id', 'invoice_id', 'is_default', 'default_label', 'line_date', 'description', 'hour_type_id', 'hour_type_name_snapshot', 'amount_mode', 'contract_id', 'contract_name_snapshot', 'timesheet_entry_id', 'entry_snapshot_json', 'last_synced_at', 'source_default_id', 'gst_code', 'source_type', 'source_id', 'source_line_id', 'created_at', 'updated_at', 'generation_id']
  },
  ...
  assessments: { headers: ['id', 'assessment_type_id', 'contract_id', 'organisation', 'assessment_date', 'field_values_json', 'percentage_adjustment', 'status', 'invoice_id', 'notes', 'created_at', 'updated_at', 'client_name', 'client_dob', 'pricing_snapshot_json', 'revision', 'client_request_id', 'last_request_id', 'migration_warning', 'lil_migrated'], text: ['id', 'assessment_type_id', 'contract_id', 'organisation', 'assessment_date', 'field_values_json', 'status', 'invoice_id', 'notes', 'created_at', 'updated_at', 'client_name', 'client_dob', 'pricing_snapshot_json', 'revision', 'client_request_id', 'last_request_id', 'migration_warning', 'lil_migrated'] },
  assessment_mutations: { headers: ['id', 'action', 'record_json', 'status'], text: ['id', 'action', 'record_json', 'status'] },
